...
Our experiments on Pythia 14M were done using the version trained on the deduplicated Pile, which is (as of Feb 27, 2026) hosted [here](https://huggingface.co/EleutherAI/pythia-14m-deduped). The HF path to this model has been updated in `src/constants.py`.
